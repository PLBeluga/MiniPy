...
echo ""
echo "🎉 MiniPy Installed Successfully!"
echo "================================="
echo ""
echo "📋 Installed:"
...
tar -czf minipy-linux-v1.0.0.tar.gz minipy-linux/
size=$(du -h minipy-linux-v1.0.0.tar.gz | cut -f1)
...
echo "📦 Tarball: minipy-linux-v1.0.0.tar.gz ($size)"
if [ -f "minipy_1.0.0_amd64.deb" ]; then
    deb_size=$(du -h minipy_1.0.0_amd64.deb | cut -f1)
    echo "📦 DEB Package: minipy_1.0.0_amd64.deb ($deb_size)"
fi
echo ""
